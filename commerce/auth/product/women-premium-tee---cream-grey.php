...
include '../config.php';
$fetchQuery = "SELECT * FROM `products` WHERE  `prod_name` = 'Women Premium Tee - Cream grey'";
...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-6 px-5">
                ...
                <div class="product-rating mt-2">
                    ...
                    <?php
                    $fetchProd = "SELECT * FROM `products` WHERE `prod_name` = 'Women Premium Tee - Cream grey'";
                    $result = $conn->query($fetchProd);


                    $query = "SELECT rating FROM review WHERE `prod_name` = 'Women Premium Tee - Cream grey'";
    ...
    <div class="container mt-5 reviews">
        <div class="details">
            ...
            $sql = "SELECT * FROM review WHERE `prod_name` = 'Women Premium Tee - Cream grey'";
