...
include '../config.php';
$fetchQuery = "SELECT * FROM `products` WHERE  `prod_name` = 'dfs updated'";
...
<body>
        ...
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ms-auto p-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="auth/cart.php">
        ...
        <div class="row">
            ...
            <div class="col-md-6 px-5">
                ...
                <div class="product-rating mt-2">
                    ...
                    <?php
                    $fetchProd = "SELECT * FROM `products` WHERE `prod_name` = 'dfs updated'";
                    $result = $conn->query($fetchProd);


                    $query = "SELECT rating FROM review WHERE `prod_name` = 'dfs updated'";
                ...
                <div class="text-center w-100 d-block">
                    ...
                    <a href="#" class="btn btn-primary mt-4 mb-5 p-3 w-50 d-inline-block" id="buyNowLink">Buy it now</a>
                </div>

                <script>
                    document.getElementById('buyNowLink').addEventListener('click', function(event) {
    ...
    <div class="container mt-5 reviews">
        <div class="details">
            ...
            $sql = "SELECT * FROM review WHERE `prod_name` = 'dfs updated'";
...
<div class="container mt-5">
    ...
    <h2 class="text-center">Similiar Products</h2>
    <hr>

    <?php

    $relatedProductsQuery = "SELECT * FROM `products` WHERE `catagory` = '$category' AND `prod_name` != '%PRODUCT_NAME%' LIMIT 3";
