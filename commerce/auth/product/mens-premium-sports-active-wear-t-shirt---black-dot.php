...
include '../config.php';
$fetchQuery = "SELECT * FROM `products` WHERE  `prod_name` = 'Mens Premium Sports Active Wear T-shirt - Black Dot'";
...
<body>
        ...
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ms-auto p-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../cart.php" style="position: relative; display: inline-block;">
        ...
        <div class="row">
            ...
            <div class="col-md-6 px-5">
                ...
                <div class="product-rating mt-2">
                    ...
                    <?php
                    $fetchProd = "SELECT * FROM `products` WHERE `prod_name` = 'Mens Premium Sports Active Wear T-shirt - Black Dot'";
                    $result = $conn->query($fetchProd);


                    $query = "SELECT rating FROM review WHERE `prod_name` = 'Mens Premium Sports Active Wear T-shirt - Black Dot'";
    ...
    <div class="container mt-5 reviews">
        <div class="details">
            ...
            $sql = "SELECT * FROM review WHERE `prod_name` = 'Mens Premium Sports Active Wear T-shirt - Black Dot'";
