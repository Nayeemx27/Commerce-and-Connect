...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="#" class="active" onclick="showProfile()" style="padding: 10px 20px; margin-bottom: 30px; display: flex; align-items: center;">
        ...
        <a href="../index.php" onclick=""><i class="fas fa-home"></i> Home</a>

        <a href="#" onclick="showDashboard()"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
        <a href="#" onclick="showHistory()"><i class="fas fa-shopping-cart"></i> Purchase History</a>
        ...
        <?php if ($isAdmin) : ?>
            ...
            <!-- Admin Panel  -->
            <div class="dropdown">
                <a href="#" class="dropdown-toggle" id="adminPanelDropdown" data-bs-toggle="dropdown" aria-expanded="true">
                    <i class="fas fa-user-cog"></i> Admin Panel
                </a>
                <ul class="dropdown-menu " aria-labelledby="adminPanelDropdown">
                    <li><a class="dropdown-item" href="#" onclick="userList()">User List</a></li>
                    <li><a class=" dropdown-item" href="#" onclick="productList()">Product List</a></li>
                    <li><a class="dropdown-item" href="#" onclick="addProduct()">Add Product</a></li>
                    <li><a class="dropdown-item" href="" onclick="viewOrders()">View Orders</a></li>
                    <li><a class="dropdown-item" href="#" onclick="event.preventDefault; showRequest()">View Request</a></li>
                    <li><a class="dropdown-item" href="#" onclick="viewReports()">View Reports</a></li>
        ...
        <?php if ($isSeller) : ?>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu " aria-labelledby="adminPanelDropdown">
                    ...
                    <li><a class=" dropdown-item" href="#" onclick="productListSeller()">Product List</a></li>
                    <li><a class="dropdown-item" href="#" onclick="addProduct()">Add Product</a></li>
        ...
        <?php if ($isBuyer) : ?>
            ...
            <a href="#" onclick="sellerRequest()"><i class="fas fa-user-plus"></i> Be a Seller</a>
            ...
            function showDashboard() {
                ...
                <div class="dashboard-div">
                    ...
                    <div class="data-div  mt-5">
                        ...
                        $allRow = mysqli_fetch_array($allOrder);

                        $fetchOrders = "SELECT COUNT(id) AS total_orders, SUM(total) AS total_spending FROM `order` WHERE order_by='$userName'";
                        ...
                        <div class="data-item">
                            <h3>Total Purchases
                                <h1>
                                    <p class="mt-3"><?php echo $orderRow['total_orders']; ?></p>
                                </h1>
                            </h3>
                        </div>
                        ...
                        <div class="data-item">
                            <h3>Total Spending
                                <p class="mt-4"><?php echo $orderRow['total_spending']; ?></p>
